...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, input_1.getUsersFromInput()];
                case 1:
                    users = _a.sent();
                    groups = transform_1.orderUsersAsExpected(users);
                    //output the models in expected format
                    return [4 /*yield*/, output_1.userArrayOfArraysToFileOutput(groups)];
                case 2:
                    //output the models in expected format
                    _a.sent();
                    return [2 /*return*/];
